...
public class Common extends ListActivity {
	...
	public Common() {
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			initializeString(0);
			parents.elements();
			ArrayAdapter<String>a=new ArrayAdapter<String>(Common.this,android.R.layout.simple_list_item_1);
		...
		protected void onListItemClick(ListView l, View v, int position, long id) {
			...
			try {
				...
				Intent ourIntent = new Intent(Common.this, Common_child.class);
