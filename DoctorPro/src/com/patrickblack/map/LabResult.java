...
public class LabResult extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.labresult);
		resultView = (TextView) findViewById(R.id.tvLabContent);
	...
	public void initializeString(int id,int sid) {
		...
		try {
			...
			StringBuffer sb =new StringBuffer(Login.MY_URL+"medication.php");
