...
public class Serious extends ListActivity{
	...
	public Serious() {
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			initializeString(0);
			parents.elements();
			ArrayAdapter<String>a=new ArrayAdapter<String>(Serious.this,android.R.layout.simple_list_item_1);
		...
		protected void onListItemClick(ListView l, View v, int position, long id) {
			...
			try {
				//Class<?> ourClass = Class.forName("com.patrickblack.map.Firstaid");
				Intent ourIntent = new Intent(Serious.this, Serious_child.class);
