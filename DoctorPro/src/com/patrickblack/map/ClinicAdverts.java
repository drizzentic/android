...
public class ClinicAdverts extends Activity {
	TextView resultView;
	String top;
	int docID;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		resultView = (TextView) findViewById(R.id.tvUpdatesContent);
	...
	public void initializeString(int id) {
		...
		try {
			...
			StringBuffer sb =new StringBuffer(Login.MY_URL+"updates.php");
