...
public class ViewApp extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		resultView = (TextView) findViewById(R.id.tvViewApp);
		...
		viewAppointment(docID,patID);
	}
	
	public void viewAppointment(int id, int sid) {
		String result = "";
		...
		try {
			...
			for (int i = 0; i < jArray.length(); i++) {
				...
				s = s + "REASON: \n" + json.getString("appointment")+"\n"+
				"__________________________\n"+
				"Date: \n" + json.getString("appointment_date")+"\n"+
				"__________________________\n"+
				"TIME: \n" + json.getString("appointment_time")+"\n"+
				"********************************";
