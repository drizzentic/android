...
public class Common_child extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.common_child);

		resultView = (TextView) findViewById(R.id.tvCommonContent);
	...
	public void initializeString(int id) {
		...
		try {
			...
			StringBuffer sb = new StringBuffer(Login.MY_URL + "common.php");
			if (id > 0)
				sb.append("?id=" + id);
