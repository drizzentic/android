...
public class Information extends ListActivity {
	...
	public Information() {
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			initializeString(0);
			parents.elements();
			ArrayAdapter<String>a=new ArrayAdapter<String>(Information.this,android.R.layout.simple_list_item_1);
		...
		protected void onListItemClick(ListView l, View v, int position, long id) {
			...
			try {
				...
				Intent ourIntent = new Intent(Information.this, ourClass);
