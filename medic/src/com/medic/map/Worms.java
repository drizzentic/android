...
public class Worms extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initializeString(0);
		parents.elements();
		ArrayAdapter<String> a = new ArrayAdapter<String>(Worms.this,
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		try {
			// Class<?> ourClass = Class.forName("com.patrickblack.map.");
			Intent ourIntent = new Intent(Worms.this, Worms_child.class);
	...
	public void initializeString(int id) {
		...
		try {
			...
			StringBuffer sb = new StringBuffer(Login.MY_URL + "worms.php");
			if (id > 0)
				sb.append("?id=" + id);
