...
public class CoreValues extends Activity {
	TextView resultView;
	String top;
	int docID;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.corevalues);
		resultView = (TextView) findViewById(R.id.tvCoreValueContent);
	...
	public void initializeString(int id) {
		...
		try {
			...
			StringBuffer sb =new StringBuffer(Login.MY_URL+"corevalues.php");
