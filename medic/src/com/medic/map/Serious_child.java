...
public class Serious_child extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.serious_child);

		resultView = (TextView) findViewById(R.id.tvSeriousContent);
