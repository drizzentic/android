...
public class bella extends ListActivity {
...
public bella() {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initializeString(0);
		parents.elements();
		ArrayAdapter<String>a=new ArrayAdapter<String>(bella.this,android.R.layout.simple_list_item_1);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		try {
			Class<?> ourClass = Class.forName("com.bella.fun.Child");
			Intent ourIntent = new Intent(bella.this, ourClass);
	...
	public void initializeString(int id) {
		...
		try {
			...
			StringBuffer sb =new StringBuffer("http://10.0.2.2/cool/firstaid.php");
